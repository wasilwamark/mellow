...
func (p *Plugin) handleShell(ctx context.Context, conn plugin.Connection, args []string, flags map[string]interface{}) error {
	fmt.Println("🔌 Opening interactive shell...")
	return conn.Shell()
}

func (p *Plugin) handleInstall(ctx context.Context, conn plugin.Connection, args []string, flags map[string]interface{}) error {
	if len(args) < 1 {
...
func (p *Plugin) handleUninstall(ctx context.Context, conn plugin.Connection, args []string, flags map[string]interface{}) error {
	if len(args) < 1 {
